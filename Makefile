CC=g++
CFLAGS=-D_DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ \
...
-pie -fPIE -Werror=vla \
-c -Wall -DCANARY_DEBUG -DHASH_DEBUG -DLOGGER_ALL
...
SOURCES=logger.cpp stack.cpp assembler.cpp input.cpp main.cpp processor.cpp processor_data.cpp
